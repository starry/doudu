...
import com.rain.doudu.bean.http.douban.BookReviewResponse;
...
import com.rain.doudu.ui.activity.BaseActivity;
import com.rain.doudu.ui.activity.BookReviewsActivity;
import com.rain.doudu.ui.activity.BookViewWebActivity;
import com.rain.doudu.ui.holder.BookSeriesCeilHolder;
...
public class BookDetailAdapter extends RecyclerView.Adapter {
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof BookInfoHolder) {
            ...
            ((BookInfoHolder) holder).mBookWebButton.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {

                    Intent intent = new Intent(UIUtils.getContext(), BookViewWebActivity.class);

                    String url = mBookInfo.getEbook_url();
                    intent.putExtra("EBOOK_URL",url);
...
//                ((BookInfoHolder) holder).tv_translator.setText("译者:" + mBookInfo.getTranslator()[0]);
    ...
    class BookInfoHolder extends RecyclerView.ViewHolder {
        ...
        public BookInfoHolder(View itemView) {
            ...
            mBookWebButton = (Button) itemView.findViewById(R.id.book_web_btn);
        }
    }
