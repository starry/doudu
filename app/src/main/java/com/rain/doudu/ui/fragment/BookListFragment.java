...
import com.rain.doudu.ui.adapter.BookListAdapter;
import com.rain.doudu.utils.common.DensityUtils;
...
public class BookListFragment extends BaseFragment implements IBookListView, SwipeRefreshLayout.OnRefreshListener {
    ...
    private static final String fields = "id,title,subtitle,ebook_url,origin_title,rating,author,translator,publisher,pubdate,summary,images,pages,price,binding,isbn13,series";
