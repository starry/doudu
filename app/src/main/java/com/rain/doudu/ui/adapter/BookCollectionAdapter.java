...
import com.rain.doudu.ui.activity.BookDetailActivity;
...
public class BookCollectionAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public BookCollectionAdapter(Context context, List<BookInfoResponse> responses, int columns) {
