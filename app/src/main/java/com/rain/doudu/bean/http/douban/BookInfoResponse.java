...
import com.rain.doudu.bean.BookRatingBean;
import com.rain.doudu.bean.BookTagBean;
import com.rain.doudu.bean.ImageBean;
import com.rain.doudu.bean.SeriesBean;
...
public class BookInfoResponse implements Serializable {
    ...
    public BookInfoResponse(String isbn13) {
        this.isbn13 = isbn13;
    }
